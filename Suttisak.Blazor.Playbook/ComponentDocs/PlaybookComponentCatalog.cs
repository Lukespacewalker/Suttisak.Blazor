...
public static class PlaybookComponentCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Summaries =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["AppCalendarPicker"] = "Calendar-based date picker with typed or UTC-instant binding and keyboard-aware date selection.",
            ["AppTimePicker"] = "Time-of-day picker that exposes a consistent typed form-control contract.",
            ["AppDateTimePicker"] = "Combined date-and-time picker with browser-local wall-time or UTC-instant binding for workflows that require one coordinated value.",
            ["FormSection"] = "Semantic form grouping with a heading, optional introduction, and structured child content.",
            ["FormGrid"] = "Responsive field grid that collapses form columns when the browser viewport is constrained.",
            ...
            ["AppDialog"] = "Modal overlay with labelled content, focus management, and configurable dismissal behavior.",
